...
import styles from './DialQuestion.module.css';
    ...
    <div className={styles.dialContainer}>
      <div className={styles.dialWrapper}>
        ...
        <div className={styles.dialCenter}>
          <div className={styles.dialPercentage}>{Math.round(localValue)}%</div>
        ...
        <div
          ...
          style={{ ['--dial-rotation' as any]: `${angle}deg` } as React.CSSProperties}
        >
          <div className={styles.dialHandleDot} />
        </div>
      ...
      <div className={styles.dialLinearControl}>
        <input
          type="range"
          min={0}
          max={100}
